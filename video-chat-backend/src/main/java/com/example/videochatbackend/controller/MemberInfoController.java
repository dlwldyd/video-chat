...
public class MemberInfoController {
    ...
    @GetMapping("/api/changeNickname")
    public ResponseEntity<String> changeNickname(@AuthenticationPrincipal MemberDetails memberDetails, @RequestParam String nickname) {
